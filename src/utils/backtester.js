const TradingStrategies = require('./trading_strategies');
const { RISK_PARAMS } = require('./config');
...
class Backtester {
  ...
  _calculatePositionSize(price) {
    const riskAmount = this.currentBalance * RISK_PARAMS.max_position_size;
